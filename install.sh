...
preparar_discos(){
    echo "primeiro formate o disco da seguinte maneira"
    echo "1- partição boot 2- partição Swap 3- partição root 4- partição home"
    cfdisk
...
local_hora_teclado(){
    ...
    hwclock --systohc
    echo 'decomente o idioma que deseja'
